...
from .services.validation import validate_url, normalize_url
...
app = FastAPI(
    title="XSave",
    description="Fast public Twitter (X) video & GIF downloader — MP4 and MP3. Public content only.",
    version="2.0.0",
)
...
async def download_video(request: Request, body: DownloadRequest):
    """Download a public Snapchat, YouTube, or Bilibili video in the selected format."""
