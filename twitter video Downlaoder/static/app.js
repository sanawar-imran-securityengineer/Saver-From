...
const TRANSLATIONS = {
  en: {
    ...
    badge: 'Twitter / X Video & GIF Downloader',
    hero_title: 'Download Twitter (X) Videos<br/><span class="x-accent">Fast, Free & in HD</span>',
    hero_sub: 'Download public Twitter / X videos, reels, and GIFs in 1080p, 720p MP4 or MP3 audio. 100% free, no login or app required.',
    url_placeholder: 'Paste Twitter or X post URL (e.g. x.com/.../status/...)',
    paste: 'Paste', btn_download: 'Download',
    loading_msg: 'Fetching Twitter video...', loading_sub: 'Converting and preparing your media file.',
    result_ready: 'Your Twitter Media is Ready!',
    btn_download_file: 'Download Video', btn_copy: 'Copy Link', btn_another: 'Download Another',
    hero_legal: 'For publicly accessible posts you have rights or permission to view. Compliant with copyright laws and platform terms.',
    how_title: 'How to Download Twitter (X) Videos', how_sub: 'Three quick steps to save any video, GIF, or reel to your device.',
    step1_title: 'Copy Tweet Link', step1_desc: 'Open X or Twitter, click the Share button on any post, and select Copy Link.',
    step2_title: 'Paste & Pick Quality', step2_desc: 'Paste the link into the search bar above and pick 1080p, 720p, 360p MP4, or MP3 audio.',
    step3_title: 'Download Video', step3_desc: 'Click Download. Your HD video or GIF is saved directly to your device.',
    safety_title: 'Why Choose XSave', safety_sub: 'Safe, private, fast, and engineered with modern web standards.',
    s1_title: 'Public Posts Only', s1_desc: 'Only publicly visible Twitter and X posts. No private or restricted content.',
    s2_title: 'No Login Required', s2_desc: 'Zero passwords, Twitter authentication, cookies, or account connections needed.',
    s3_title: 'Auto-Delete in 30 Min', s3_desc: 'Downloaded media files are automatically erased from servers within 30 minutes.',
    s4_title: 'Lightning Fast Caching', s4_desc: 'Multi-layer in-memory caching serves popular videos in split seconds.',
    s5_title: 'MP4 & MP3 Extractor', s5_desc: 'Extract high-bitrate audio from Twitter spaces, speeches, or clips as MP3 files.',
    s6_title: 'Works on All Devices', s6_desc: 'Responsive and optimized for Safari, Chrome, iOS, Android, Windows, and Mac.',
    ...
    terms_h1: 'Acceptable Use', terms_p1: 'Use XSave to download publicly accessible Twitter/X videos you have permission to use.',
    ...
    faq_title: 'Frequently Asked Questions', faq_sub: 'Everything you need to know about downloading Twitter (X) videos.',
    faq_q1: 'How do I get the video link from Twitter / X?', faq_a1: 'Click the Share button on any tweet and tap "Copy Link". Paste it above.',
    faq_q2: 'Can I download GIFs from Twitter?', faq_a2: 'Yes! Twitter GIFs are downloaded as high quality MP4 videos.',
    faq_q3: 'Do I need an account or software?', faq_a3: 'No. XSave is 100% free and web-based. No account or app needed.',
    faq_q4: 'Can I download videos from private accounts?', faq_a4: 'No. XSave only supports publicly accessible tweets.',
    faq_q5: 'What formats are available?', faq_a5: '1080p Full HD, 720p HD, 360p SD, and MP3 audio.',
    faq_q6: 'Is this fast?', faq_a6: 'Yes! Caching ensures instant download preparation.',
    footer_tagline: 'Fast, Free Twitter (X) Video & GIF Downloader',
    ...
    err_empty: 'Please enter a Twitter or X post URL.', err_invalid: 'Please enter a valid Twitter/X video link (e.g. x.com/.../status/...).',
  ...
  ur: {
    nav_home: 'ہوم', nav_how: 'طریقہ کار', nav_safety: 'حفاظت',
    nav_faq: 'سوالات', nav_terms: 'شرائط', nav_privacy: 'رازداری',
    badge: 'ٹویٹر / X ویڈیو اور GIF ڈاؤنلوڈر',
    hero_title: 'ٹویٹر (X) ویڈیوز ڈاؤنلوڈ کریں<br/><span class="x-accent">تیز، مفت اور HD میں</span>',
    hero_sub: 'عوامی ٹویٹر / X ویڈیوز اور GIFs کو 1080p، 720p MP4 یا MP3 میں ڈاؤنلوڈ کریں۔ کوئی لاگ ان درکار نہیں۔',
    url_placeholder: 'ٹویٹر یا X پوسٹ کا لنک یہاں پیسٹ کریں...',
    paste: 'پیسٹ', btn_download: 'ڈاؤنلوڈ',
    loading_msg: 'ٹویٹر میڈیا تیار ہو رہا ہے...', loading_sub: 'کچھ ہی دیر میں فائل ڈاؤنلوڈ کے لیے تیار ہوگی۔',
    ...
    how_title: 'ٹویٹر ویڈیوز کیسے ڈاؤنلوڈ کریں', how_sub: 'تین آسان مراحل میں کوئی بھی ٹویٹ ویڈیو محفوظ کریں۔',
    step1_title: 'لنک کاپی کریں', step1_desc: 'ٹویٹر یا X پر شیئر بٹن دبائیں اور "کاپی لنک" منتخب کریں۔',
    step2_title: 'پیسٹ اور کوالٹی کا انتخاب', step2_desc: 'سرچ بار میں لنک پیسٹ کریں اور 1080p، 720p یا MP3 منتخب کریں۔',
    step3_title: 'ڈاؤنلوڈ کریں', step3_desc: 'ڈاؤنلوڈ پر کلک کریں اور ویڈیو اپنے موبائل یا کمپیوٹر پر محفوظ کریں۔',
    safety_title: 'XSave کی خصوصیات', safety_sub: 'محفوظ، نجی اور جدید ترین ٹیکنالوجی پر مبنی۔',
    s1_title: 'صرف عوامی پوسٹس', s1_desc: 'صرف پبلک ٹویٹس اور ویڈیوز ڈاؤنلوڈ کی جا سکتی ہیں۔',
    s2_title: 'کوئی لاگ ان نہیں', s2_desc: 'کوئی اکاؤنٹ، پاس ورڈ یا کوکیز درکار نہیں۔',
    s3_title: '30 منٹ میں خودکار حذف', s3_desc: 'تمام فائلیں 30 منٹ میں سرور سے خودبخود مٹا دی جاتی ہیں۔',
    s4_title: 'انتہائی تیز رفتار کیشنگ', s4_desc: 'مشہور ویڈیوز لمحوں میں ڈاؤنلوڈ ہو جاتی ہیں۔',
    s5_title: 'MP4 اور MP3', s5_desc: 'ویڈیو کے ساتھ ساتھ صرف آڈیو (MP3) بھی ڈاؤنلوڈ کی جا سکتی ہے۔',
    s6_title: 'ہر ڈیوائس پر دستیاب', s6_desc: 'آئی فون، اینڈرائڈ، ونڈوز اور میک سب پر کام کرتا ہے۔',
    ...
    faq_title: 'اکثر پوچھے گئے سوالات', faq_sub: 'ٹویٹر ویڈیو ڈاؤنلوڈ کے بارے میں معلومات۔',
    faq_q1: 'ٹویٹر سے لنک کیسے حاصل کریں؟', faq_a1: 'پوسٹ پر شیئر بٹن دبائیں اور "کاپی لنک" کا انتخاب کریں۔',
    faq_q2: 'کیا GIF ڈاؤنلوڈ ہو سکتی ہے؟', faq_a2: 'ہاں! ٹویٹر GIFs کو ہائی کوالٹی MP4 ویڈیو میں محفوظ کیا جاتا ہے۔',
    faq_q3: 'کیا کوئی اکاؤنٹ چاہیے؟', faq_a3: 'نہیں۔ یہ مکمل طور پر مفت اور بغیر اکاؤنٹ کے ہے۔',
    faq_q4: 'کیا پرائیویٹ ٹویٹس ڈاؤنلوڈ ہو سکتی ہیں؟', faq_a4: 'نہیں۔ صرف عوامی (پبلک) ٹویٹس سپورٹ کی جاتی ہیں۔',
    ...
    footer_tagline: 'مفت ٹویٹر (X) ویڈیو ڈاؤنلوڈر',
    ...
    err_empty: 'براہ کرم ٹویٹر / X لنک درج کریں۔', err_invalid: 'براہ کرم ایک درست ٹویٹر / X پوسٹ لنک درج کریں۔',
...
const TWITTER_REGEX = /^https?:\/\/(www\.|mobile\.)?(twitter\.com|x\.com)\/(?:[^/]+\/status\/|i\/status\/)\d+/i;
const YT_REGEX = /^https?:\/\/(www\.)?(youtube\.com\/(watch\?.*v=|shorts\/)|youtu\.be\/)[a-zA-Z0-9_-]{6,}/i;
const OTHER_REGEX = /^https?:\/\/(www\.)?(snapchat\.com|bilibili\.com|b23\.tv)\//i;

function validateUrl(url) {
  if (!url || !url.trim()) return { valid: false, msg: t('err_empty') };
  if (url.length > 2048) return { valid: false, msg: t('err_long') };
  const u = url.trim();
  if (TWITTER_REGEX.test(u) || YT_REGEX.test(u) || OTHER_REGEX.test(u)) {
    return { valid: true };
  }
  if ((u.includes('twitter.com') || u.includes('x.com')) && /status\/\d+/.test(u)) {
    return { valid: true };
  }
...
urlInput.addEventListener('input', () => {
  ...
  urlStatus.textContent = '✓ Valid Twitter / X post URL';
...
function renderInfoPreview(data) {
  ...
  if (channelEl) channelEl.textContent = data.uploader || 'Twitter User';
  ...
  if (likesEl && data.like_count) {
    const statText = likesEl.querySelector('.stat-text');
    if (statText) statText.textContent = `${formatNumber(data.like_count)} Likes`;
  }
