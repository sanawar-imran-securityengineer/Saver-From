...
SUPPORTED_HOSTS = SNAPCHAT_HOSTS | BILIBILI_HOSTS | YOUTUBE_HOSTS
...
def validate_url(url: str) -> Tuple[bool, Optional[str]]:
    """Validate a Snapchat, YouTube, or Bilibili URL.

    Returns (True, None) if valid, (False, error_message) otherwise.
    """
    if not url or not url.strip():
        return False, "Please enter a Snapchat video URL."
    ...
    if host not in SUPPORTED_HOSTS:
        return False, "This URL is not supported. Please enter a Snapchat video URL."
